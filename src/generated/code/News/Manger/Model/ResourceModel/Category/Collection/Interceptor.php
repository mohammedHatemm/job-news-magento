<?php
namespace News\Manger\Model\ResourceModel\Category\Collection;

/**
 * Interceptor class for @see \News\Manger\Model\ResourceModel\Category\Collection
 */
class Interceptor extends \News\Manger\Model\ResourceModel\Category\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinParentCategory');
        return $pluginInfo ? $this->___callPlugins('joinParentCategory', func_get_args(), $pluginInfo) : parent::joinParentCategory();
    }
