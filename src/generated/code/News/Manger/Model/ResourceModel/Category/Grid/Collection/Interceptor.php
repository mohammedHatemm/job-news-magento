<?php
namespace News\Manger\Model\ResourceModel\Category\Grid\Collection;

/**
 * Interceptor class for @see \News\Manger\Model\ResourceModel\Category\Grid\Collection
 */
class Interceptor extends \News\Manger\Model\ResourceModel\Category\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, $mainTable, $eventPrefix, $eventObject, $resourceModel, $model = 'News\\Manger\\Model\\Category', $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addNameFilter');
        return $pluginInfo ? $this->___callPlugins('addNameFilter', func_get_args(), $pluginInfo) : parent::addNameFilter($name);
    }
