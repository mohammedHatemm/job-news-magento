...
class Interceptor extends \News\Manger\Model\ResourceModel\Category\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRootFilter');
        return $pluginInfo ? $this->___callPlugins('addRootFilter', func_get_args(), $pluginInfo) : parent::addRootFilter($isRoot);
    }
