...
class Interceptor extends \News\Manger\Block\Adminhtml\News\Edit\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\Block\Template\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\Data\FormFactory $formFactory, \News\Manger\Model\ResourceModel\Category\CollectionFactory $categoryCollectionFactory)
    {
        $this->___init();
        parent::__construct($context, $registry, $formFactory, $categoryCollectionFactory);
    }
